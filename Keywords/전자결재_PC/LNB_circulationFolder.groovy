...
public class LNB_circulationFolder {

	@Keyword
	public void circulationFolder(){
		...
		//공람 선택
		WebElement inbox = driver.findElement(By.xpath('//*[@id="gnbContent"]/div/ul/li[4]/a/span'))
		action.click(inbox)
		action.perform()
		...
		//검색필터 초기화 용도
		WebUI.navigateToUrl('https://approval.we.kakaowork.com/box/sh')
