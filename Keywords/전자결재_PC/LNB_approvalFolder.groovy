...
public class LNB_approvalFolder {
	...
	public void toApprove(){
		...
		def expectedURL = "https://approval.we.kakaowork.com/box/ab"
	...
	public void inProgress(){
		...
		//조회버튼 기능 동작 확인
		def currentURL = WebUI.getUrl()
		def expectedURL = "https://approval.we.kakaowork.com/box/ai"
		if(currentURL == expectedURL)
		{
			throw new StepErrorException("url이 그대로임 조회버튼 기능확인 필요")
		}
	...
	public void completed(){
		...
		//조회버튼 기능 동작 확인
		def currentURL = WebUI.getUrl()
		def expectedURL = "https://approval.we.kakaowork.com/box/ac"
		if(currentURL == expectedURL)
		{
			throw new StepErrorException("url이 그대로임 조회버튼 기능확인 필요")
		}
	...
	public void rejected(){
		...
		//조회버튼 기능 동작 확인
		def currentURL = WebUI.getUrl()
		def expectedURL = "https://approval.we.kakaowork.com/box/ar"
		if(currentURL == expectedURL)
		{
			throw new StepErrorException("url이 그대로임 조회버튼 기능확인 필요")
		}
