...
public class LNB_referenceFolder {

	@Keyword
	public void referenceFolder(){
		...
		//참조함 선택
		WebElement inbox = driver.findElement(By.xpath('//*[@id="gnbContent"]/div/ul/li[5]/a/span'))
		action.click(inbox)
		action.perform()
		...
		//검색필터 초기화 용도
		WebUI.navigateToUrl('https://approval.we.kakaowork.com/box/cc')
